...
public class Main3 {
	...
	public static void main(String[] args ) {
		...
		String jpql="Select b from Books b join b.authors a where a.authorName='Komal'";
		TypedQuery<Books> tquery = entityManager.createQuery(jpql, Books.class);
		List<Books> result=tquery.getResultList();
		
		for(Books b1: result){
			System.out.println("Book Id: "+b1.getISBN());
		...
		for (Authors books2 : books) {
			...
			System.out.println("author Id: "+books2.getAuthorId());
			System.out.println("author name: "+books2.getAuthorName());
